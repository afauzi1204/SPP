  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="<?php site_url('manage') ?>" class="logo">
        ...
        <?php if (!empty(logo())) { ?>
          <span class="logo-lg">
          <span><img src="<?php echo media_url('img/logo-mupat.png')?>" width="30px"></span>
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <?php if ($this->session->userdata('student_img') != null) { ?>
                  <!-- <img src="<?php echo upload_url('student/' . $student['student_img']) ?>" class="user-image"> -->
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright © AF <?php echo $this->config->item('created') ?> <?php echo $this->config->item('app_name') ?>.</strong>
      All rights reserved.
    </footer>
    <div class="navbar navbar-default navbar-fixed-bottom hidden-lg hidden-md hidden-sm">
      <div class="bott-bar hidden-lg hidden-md hidden-sm">
        <div class="pos-bar">
          ...
          <!-- <a class="content-bar" data-toggle="tooltip" title="Helpdesk">
            <div class="group-bot-bar">
              
            <!-- <?php $nowa = 6281558444434; //nomor disesuaikan -->
            // $link='https://wa.me/'.$nowa.'?text=Assalamualaikum Wr.Wb. Mohon Bantuannya%0ANama:%0AKelas:%0APertanyaan:'?>
             <!-- <?php echo '<a href="https://wa.me/'.$nowa.'?text=Assalamualaikum Wr.Wb. Mohon Bantuannya%0ANama:%0AKelas:%0APertanyaan:">';?> -->
            <!-- <?php echo '<a href="https://www.google.com">' ?> -->
            <!-- <i class="fa fa-phone icon-bot-bar"></i> -->
            <!-- </div> -->
          <!-- </a> -->
