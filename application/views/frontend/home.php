  <div class="box box-info box-solid" style="border: 1px solid #2ABB9B !important;">
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <?php echo form_open(current_url('/payout'), array('class' => 'form-horizontal', 'method' => 'get')) ?>
        <label for="" class="col-sm-2 control-label">Cari Data Transaksi</label>
        <div class="col-sm-3">
								<!-- <select class="form-control" name="r">
									<?php foreach ($student as $row) : ?>
										<option <?php echo (isset($f['r']) and $f['r'] == $row['student_id']) ? 'selected' : '' ?> value="<?php echo $row['student_nis'] ?>">
  ...
  <?php if ($f) { ?>
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="box box-info box-solid" style="border: 1px solid #2ABB9B !important;">
          <div class="box-header backg with-border">
            <h3 class="box-title">TAGIHAN TAHUNAN</h3>
          </div><!-- /.box-header -->
          <div class="box-body table-responsive">
