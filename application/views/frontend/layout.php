	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="col-md-12">
			<?php if (isset($setting_school) and $setting_school['setting_value'] == '-') { ?>
				<a class="navbar-brand" href="<?php echo site_url('/manage'); ?>"><span><img src="<?php echo media_url('img/logo-mupat.png')?>" width="30px"></span></span>&nbsp;<b> <?php echo $this->config->item('app_name') ?></b></a>
			<?php } else { ?>
				<a class="navbar-brand" href="<?php echo site_url('/manage'); ?>"><span><img src="<?php echo media_url('img/logo-mupat.png')?>" width="30px"></span></span>&nbsp;<b> <?php echo $this->config->item('app_name') ?></b></a>
			<?php } ?>
