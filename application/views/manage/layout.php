...
<head>
  ...
  <!-- <link rel="stylesheet" href="<?php echo media_url() ?>/css/css-5/all.css"> -->
  <!-- <link rel="stylesheet" href="<?php echo media_url() ?>/css/css-5/all.min.css"> -->
  <!-- <link rel="stylesheet" href="<?php echo media_url() ?>/css/css-5/font-awesome.min.css"> -->
  <!-- <link rel="stylesheet" href="<?php echo media_url() ?>/css/css-5/font-awesome.css"> -->
  ...
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        <b><?php echo $this->config->item('app_name') ?></b> version <?php echo $this->config->item('version') ?>
      </div>
      <strong>Copyright © AF <?php echo $this->config->item('created') ?>.</strong>
      All rights reserved. 
      <!-- <span class="navbar-text text-center">
      &nbsp; <?php echo $this->config->item('full_app_name') ?>
      </span> -->
    </footer>
