							...
							<div class="col-sm-6">
								<div class="box-tools">
									...
									<div class="input-group input-group-sm">
										<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="' . $f['n'] . '"' : 'placeholder="Cari Tingkatan"' ?> class="form-control" required>
					...
					<div class="box-body table-responsive">
						<table class="table table-hover table-striped table-bordered">
							<tr class="bg-blue">
								...
								<th class="text-center" width=50%>Tingkatan</th>
								<!-- <th>ID Kelas</th> -->
