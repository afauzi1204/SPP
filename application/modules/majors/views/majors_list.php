				...
				<div id="p_scents_majors">
					<div class="row">
						<div class="col-md-6">
							...
							<input type="text" required="" name="majors_name[]" class="form-control" placeholder="Contoh: TEKNIK KENDARAAN RINGAN OTOMOTIF">
						</div>
						<div class="col-md-6">
							<label>Singkatan</label>
							<input type="text" required="" name="majors_short_name[]" class="form-control" placeholder="Contoh: TKRO">
						</div>
					</div>
				</div>
