		...
		<div class="row">
			<div class="col-md-12">
				<div class="callout callout-info">
					<b>PERINGATAN!</b> <br>
					Halaman ini digunakan untuk merubah status siswa menjadi lulus. Pastikan siswa yang diproses adalah siswa kelas akhir.<br>
					Dan, bisa digunakan untuk membatalkan kelulusan jika terdapat kesalan dalam proses kelulusan.
				</div>
			</div>
		</div>
		<!-- /.box-header -->
					...
					<div class="box-body">
						...
						<div class="form-group">
							<div class="input-group">
								<div class="input-group-addon alert-warning">Pilih kelas</div>
