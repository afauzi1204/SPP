    ...
    <div class="container">
      ...
      <table class="name">
        ...
        <tr>
          <td>Kelas</td>
          <td>:</td>
          <td><?php echo $student['class_name'] . ' ' ; echo $student['majors_name'] ?></td>
        </tr>
      ...
      <!-- <img style="width:142.56pt;height:18pt;z-index:6;" src="<?php echo media_url() . '/barcode_student/' . pretty_date($student['student_born_date'], 'dmy') . '.png' ?>" alt="Image_4_0" /> -->
      <p style="font-size: 5pt;margin-left: 25%;margin-top:-0px;"><?php echo pretty_date($student['student_born_date'] , 'd m Y', false) ?></p>
