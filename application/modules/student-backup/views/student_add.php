						...
						<div class="form-group">
							...
							<div class="radio">
								<label style="margin-right: 15px;">
									<input type="radio" name="student_status" value="1" <?php echo ($inputStatusValue == 0) ? 'checked' : ''; ?>> Aktif
								</label>
								<label class="pull-center">
									<input type="radio" name="student_status" value="0" <?php echo ($inputStatusValue == 1) ? 'checked' : ''; ?>> Tidak Aktif
								</label>
							</div>
						</div>
						<label>Foto</label>
