            ...
            <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 10px;">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <?php
                  ?>
                  <span class="info-box-text dash-text">Total Pengeluaran</span>
                  <span class="info-box-number"><?php echo 'Rp. ' . number_format($t_total_kredit, 0, ',', '.') ?></span>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 10px;">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  $totalAll = $t_total_bulan + $t_total_bebas + $t_total_debit;
                  ?>
                  <span class="info-box-text dash-text">Total Saldo</span>
                  <span class="info-box-number"><?php echo 'Rp. ' . number_format($totalAll - $t_total_kredit, 0, ',', '.') ?></span>
                  <!-- <span class="info-box-number"><?php echo 'Rp. ' . number_format($totalAll, 0, ',', '.') ?></span> -->
                </div>
              </div>
