			...
			<div class="col-md-12">
				<div class="box box-warning">
					<div class="box-header with-border">
						<div class="row">
							<div class="col-sm-6">
								<a href="<?php echo site_url('manage/payment/add') ?>" class="btn btn-sm bg-orange"><i class="fa fa-plus"></i> Tambah</a>
							</div>
							<div class="col-sm-6">
								<div class="box-tools">
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td><?php echo ($row['payment_type'] == 'BULAN') ? 'Bulanan' : 'Tahunan' ?></td>
