							...
							<table class="table table-responsive table-hover table-bordered" style="white-space: nowrap;">
								...
								<?php foreach ($bulan as $key) : ?>
									<tr>
										...
										<td><?php echo $key['pos_name'] . ' - T.P ' . $key['period_start'] . '/' . $key['period_end']; ?></td>
										<td><?php echo strtoupper($key['student_full_name']) ?></td>
										<td class="text-center"><?php echo $key['class_name'] . ' ' . $key['majors_name'] ?></td>
								...
								<?php foreach ($dom as $key) : ?>
									<tr>
										...
										<td class="text-center"><?php echo $key['class_name'] . ' ' . $key['majors_name'] ?></td>
										<td><?php echo pretty_date($key['bebas_pay_input_date'], 'd/m/Y')  ?></td>
										<td><?php echo 'Rp. ' . number_format($key['bebas_pay_bill'], 0, ',', '.') ?></td>
										<td>-</td>
										<td><?php echo $key['bebas_pay_desc'] ?></td>
									</tr>
								<?php endforeach ?>
