					...
					<div class="box box-success">
						<div class="box-header with-border">
							...
							<?php if ($f['n'] and $f['r'] != NULL) { ?>
								...
								<a href="<?php echo site_url('manage/payout/printBill' . '/?' . http_build_query($f)) ?>" target="_blank" class="btn bg-orange btn-xs text-bold pull-right" style="margin-right: 75px;"><i class="fa fa-print"></i>&nbsp; Cetak Semua Tagihan</a>
							<?php } ?>
						</div>
						<div class="box-body">
							<div class="col-md-9">
							...
							<div class="box-body">
								<div class="nav-tabs-custom tab-success">
									<ul class="nav nav-tabs">
										<li class="active bg-success"><a href="#tab_2" data-toggle="tab"><b>Tahunan</b>&nbsp; <i class="fa fa-shopping-cart"></i></a></li>
										<li class="bg-success"><a href="#tab_1" data-toggle="tab"><b>Bulanan</b> &nbsp;<i class="fa fa-shopping-cart"></i></a></li>
									</ul>
								</div>
											...
											<table class="table table-hover table-responsive table-bordered" style="white-space: nowrap;">
												...
												<tbody>
													...
													foreach ($bebas as $row) :
														if ($f['n'] and $f['r'] == $row['student_nis']) {
															$sisa = $row['bebas_bill'] - $row['bebas_total_pay']; // untuk mencari sisa tunggakan
															$total = $row['bebas_bill']; // untuk menampilkan total tagihan
													?>
															<tr class="<?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? 'success' : 'danger' ?>">
																...
																<td><?php echo 'Rp. ' . number_format($row['bebas_bill'] - $row['bebas_total_pay'], 0, ',', '.') ?></td>
																...
																<td class="text-center">
																	<a data-toggle="modal" class="btn btn-info btn-xs <?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? 'disabled' : '' ?>" title="Bayar" href="#addRincian<?php echo $row['bebas_id'] ?>"><span class="fa fa-dollar"></span> <b>Keterangan</b></a>
																</td>
															</tr>
