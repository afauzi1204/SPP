					...
					<div class="box-body">
						<table class="table table-responsive table-bordered" style="white-space: nowrap;">
							<tr class="success">
								...
								<th><i class="fa fa-dollar"></i> Tagihan</th>
				...
				<div class="box box-danger">
					...
					<div class="box-body">
						<form action="<?php echo site_url('student/payout/cetakBukti') ?>" method="GET" class="view-pdf">
							...
							<button class="btn bg-maroon btn-block" formtarget="_blank" type="submit"><i class="fa fa-print"></i> <b> Cetak Bukti Pembayaran</b></button>
						</form>
					</div>
				</div>
			</div>
