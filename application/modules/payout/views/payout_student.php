					...
					<div class="box-body">
						<div class="nav-tabs-custom tab-success">
							<ul class="nav nav-tabs">
								...
								<li class="bg-success"><a href="#tab_2" data-toggle="tab"><b>Tahunan</b>&nbsp; <i class="fa fa-shopping-cart"></i></a></li>
							</ul>
						</div>
											...
											?>
												<tr class="<?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? 'success' : 'danger' ?>">
													...
													<td class="text-center">
														<a href="<?php echo site_url('student/payout/payout_bebas/' . $row['payment_payment_id'] . '/' . $row['student_student_id'] . '/' . $row['bebas_id']) ?>" class="view-cicilan label <?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? 'label-success' : 'label-danger' ?>"> <i class="fa fa-warning"></i> <?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? 'Lunas' : 'Belum Lunas' ?></a>
													</td>
													<td class="text-center">
														<a data-toggle="modal" class="btn bg-primary btn-sm <?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? 'disabled' : '' ?>" title="Bayar" href="#keterangan<?php echo $row['bebas_id'] ?>"><span class="fa fa-dollar"></span> <b>Rincian</b></a>
													</td>
												</tr>
