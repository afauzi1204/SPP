...
class Student_model extends CI_Model
{
    ...
    function get($params = array())
    {
        ...
        if (isset($params['order_by'])) {
            ...
            $this->db->order_by('student_full_name' and 'class_name' and 'majors_name', 'asc');
        }
        $this->db->select('student.student_id, student_nis, student_nisn, student_password, 
        student_gender, student_phone, student_hobby, student_address, student_parent_phone, 
        student_full_name, student_born_place, student_born_date, student_img, student_status, 
        student_name_of_mother, student_name_of_father, student_input_date, student_last_update');
    ...
    function get_majors($params = array())
    {
        ...
        if (isset($params['order_by'])) {
            ...
            $this->db->order_by('majors_name', 'asc');
        }
