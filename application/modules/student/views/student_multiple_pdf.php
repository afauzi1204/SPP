      ...
      <div class="container">
        ...
        <table class="name">
          ...
          <tr>
            <td>Kelas</td>
            <td>:</td>
            <td><?php echo $row['class_name'] . ' ' ; echo $row['majors_short_name']?></td>
          </tr>
        ...
        <p style="font-size: 5pt;margin-left: 25%;margin-top:-0px;"><?php echo pretty_date($row['student_born_date'] , 'd m Y', false) ?></p>
    </fieldset>
    <?php if ($i == 3) : ?>
      <br>
    <?php $i = 0;
