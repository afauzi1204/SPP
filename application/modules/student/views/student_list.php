								...
								?>
										<tr>
											...
											<td class="text-center">
												<div class="btn-group">
													<a href="<?php echo site_url('manage/student/rpw/' . $row['student_id']) ?>" class="btn btn-sm bg-orange" data-toggle="tooltip" title="Ganti Password"><i class="fa fa-unlock"></i></a>
