			...
			<div class="col-md-9">
				<div class="box box-solid">
					<div class="box-header with-border">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="box-title" style="padding-top: 5px;">Data Peserta Didik</h3>
							</div>
							<div class="col-sm-6">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<div class="input-group">
								<div class="input-group-addon bg-maroon">Pilih kelas</div>
									...
									<?php if ($this->input->get(NULL)) { ?>
										...
										?>
												<tr style="<?php echo ($row['student_status'] == 0) ? 'color:#00E640' : '' ?>">
													...
													<td class="text-center"><?php echo $row['class_name'];echo " "; echo $row['majors_name']; ?></td>
													<!-- <td class="text-center"><?php echo $row['class_name']; echo $row['major_name']; ?></td> -->
			...
			<div class="col-md-3">
				<div class="box box-solid">
					...
					<div class="box-body">
						...
						<br>
						<button class="btn bg-maroon btn-block" type="submit"><span class="fa fa-check"></span> <b>Proses Naik Kelas</b></button>
						</form>
					</div>
				</div>
			</div>
