...
class Setting_model extends CI_Model {
    ...
    //     if (isset($params['id'])) {
    //         $this->db->where('setting_id', $params['id']);
    //     }
        
    //     if (isset($params['setting_school'])) {
    //         $this->db->where('setting_school', $params['setting_school']);
    //     }

    //     if (isset($params['setting_logo'])) {
    //         $this->db->where('setting_logo', $params['setting_logo']);
    //     }

    //     if (isset($params['id']) OR isset($params['setting_school'])) {
    //         return $this->db->get('setting')->row_array();
    //     } else {
    //         return $this->db->get('setting')->result_array();
    //     }
